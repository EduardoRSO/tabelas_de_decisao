...
class HandlerAnalysis:
    ...
    def visualization_core(self):
        ...
        while True:
            ...
            #2[
            #2 #TD decision table td_analysis
            #2 #TD sets
            #2 #TD        1                                                {1}
            #2 #TD        2                                                {2}
            #2 #TD        3                                                {3}
            ...
            #2 #TD        option                                           1   2   3   4
            #2 #TD actions
            #2 #TD        self.set_choosed_options()                       1   0   0   0                                            
            #2 #TD        self.contribution_graph()                        2   0   0   0                        
            #2 #TD        self.variation_graph()                           0   0   0   0                        
            #2 #TD        self.show_available_options()                    0   1   0   0                        
            #2 #TD        self.show_visualization_core_exit_message()      0   0   1   1                        
            #2 #TD        self.show_invalid_option_message(graph_option)   0   0   S0   0                        
            #2 #TD        self.show_success_message()                      3   0   0   0                        
            #2 #TD end table
            #2]
...
if __name__ == '__main__':
    ...
    while True:
        option = int(input('> Please choose an option:\n'
                       ...
                       '  3 - Quit the program\n> '))
        #2[
        #2 #TD decision table td_main
        #2 #TD sets
        #2 #TD        opcao_valida                     {1,2,3,12,13,123}SS
        #2 #TD        atualiza                         {1}
        #2 #TD        analisa                          {2}
        #2 #TD        sai                              {3}
        #2 #TD        atualiza_analisa                 {12}
        #2 #TD        atualiza_sai                     {13}
        #2 #TD        atualiza_analisa_sai             {123}
        #2 #TD conditions
        #2 #TD        option                           opcao_valida  opcao_valida opcao_valida opcao_valida        opcao_valida opcao_valida 
        #2 #TD        option                           atualiza      analisa      sai          atualiza_analisa    atualiza_sai atualiza_analisa_sai
        #2 #TD actions
        #2 #TD        analysis.visualization_core()    0             1            0            2                   0            2
        #2 #TD        updater.update_core()            1             0            0            1                   1            1  
        #2 #TD        quit_program()                   0             0            1            0                   2            3
        #2 #TD end table
        #2]
